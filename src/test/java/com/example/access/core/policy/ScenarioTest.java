package com.example.access.core.policy;

import com.example.access.core.attribute.Attribute;
import com.example.access.core.attribute.DefaultAttributeProvider;
import com.example.access.core.context.Context;
import com.example.access.core.context.DefaultContextManager;
...
@SpringBootTest(classes = { com.pandaterry.access_orchestrator.AccessOrchestratorApplication.class })
class ScenarioTest {
        @Autowired
